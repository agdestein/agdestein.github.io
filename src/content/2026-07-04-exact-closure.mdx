...
import ThreePathsMap from '../components/ThreePathsMap.vue';
import ProjectionPlayground from '../components/ProjectionPlayground.vue';
import RstLadder from '../components/RstLadder.vue';
import '../styles/2026-07-04-exact-closure.css';
import RelatedPublications from '../components/RelatedPublications.astro';

**An interactive companion to our paper:**

<RelatedPublications work="exactClosure" />
...
<ProjectionPlayground client:visible />
