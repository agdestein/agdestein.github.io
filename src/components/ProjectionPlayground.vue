<template>
  <div class="xclp">
    ...
    <p class="mobile-projection-key">Dashed: removed pressure gradient. Highlighted solid line: retained divergence-free field.</p>
    <p class="illustration-note">A two-dimensional geometric illustration of the projection.</p>
