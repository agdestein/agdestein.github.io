<template>
  <div class="tifd">
    ...
    <div class="tifd-plot" tabindex="0" role="region" aria-label="Filter comparison plot; scroll horizontally on small screens"><svg :viewBox="`0 0 ${W} ${H}`" class="tifd-svg" role="img"
    ...
    <p class="tifd-readout">
      ...
      <strong>{{ slope.toFixed(3) }}</strong> — equal <em>exactly</em>, for every τ and every t. <span class="illustration-note">Analytic demonstration, not experimental data.</span>
    </p>
  </div>
</template>
