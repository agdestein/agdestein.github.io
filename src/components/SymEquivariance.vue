<template>
  <div class="symeq">
    ...
    <p class="illustration-note">Illustrative field and closure rules, not the trained networks.</p>
...
<style>
.symeq {
  --symeq-a: var(--series-1);
  --symeq-b: var(--series-3);
  --symeq-ok: var(--series-2);
